<%-- 
    Document   : edit
    Created on : May 9, 2016, 4:16:19 PM
    Author     : kiwi
--%>
	...
	<form action="<c:url value="/system/do/editdata" />" name="addArticleForm" id="addForm" method="POST" type="multipart/form-data">
            ...
            <div class="row add-row">
                ...
                <div class="col-lg-6 margintop10 field titles">
                    <input type="text" name="titleUA" class="form-control input-title-lang" lang="titleUA" id="tltUA" value="${project.project_name_ua}"  maxlength="55">
                    <input type="text" name="titleEN" class="form-control input-title-lang" lang="titleEN" id="tltEN" value="${project.project_name_en}"  maxlength="55">
        ...
        <p>
            <button class="btn btn-success margintop30 marginbottom30 sudmitData" type="submit">Save</button>
